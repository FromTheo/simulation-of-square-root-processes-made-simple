...
We implement: 
- Simulation of the iVi scheme, along with other discretizations, including Andersen's Truncatured Gaussian (TG) and Quadratic Exponential (QE) schemes, and Alfonsi's second-order scheme. 
...
In addition, we provide a technical note (`technical_note.pdf`) detailing the construction of the TG(-M), QE(-M), and Alfonsi second-order schemes. 
